...
var ListagemMaisConsumidosGenero = /** @class */ (function (_super) {
    __extends(ListagemMaisConsumidosGenero, _super);
    function ListagemMaisConsumidosGenero(clientes, produtos, servicos) {
    ...
    ListagemMaisConsumidosGenero.prototype.listar = function () {
        var _this = this;
    ...
    return ListagemMaisConsumidosGenero;
}(listagem_1.default));
exports.default = ListagemMaisConsumidosGenero;
